...
class SignInPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def sign_in():
            """t1 = threading.Thread(target= Logic.check_sign_in(username_entry.get(), password_entry.get()))
            t2 = threading.Thread(target= Logic.check_admin(username_entry.get(), password_entry.get()))"""
